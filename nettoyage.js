...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ✅ Prompt renforcé avec rappel critique et règles explicites
    const prompt = `
    ...
    // Appel à l'API Scaleway avec budget et effort de raisonnement
    const response = await fetch('https://api.scaleway.ai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        temperature: 0.1,
        max_tokens: 4000,           // ✅ budget de réponse
    ...
    // ✅ Validation fallback pour columnTypes
